export const personalInfo = {
  ...
  availability: "PortalWiz Technologies",
...
export const experience = [
  {
    ...
    company:  "PortalWiz Technologies Pvt. Ltd.",
    type:     "Full-time",
    period:   "Sep 2026 — Present",
    location: "Pune, India",
    color:    "#6c63ff",
    description: "Contributing to full-lifecycle software development, building performant, responsive web applications, and engineering reliable digital solutions for client products.",
    achievements: [
      "Developing scalable, responsive web interfaces and reusable UI component architectures",
      "Collaborating on feature modules, frontend engineering, and backend service integration",
      "Writing clean, maintainable code following modern software engineering best practices",
      "Participating in agile sprints, code reviews, and client requirement implementations",
    ],
    tech: ["React.js","TypeScript","JavaScript","Node.js","Tailwind CSS","REST API","Git"],
  },
  {
    id: 2,
